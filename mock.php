...
$tpl->assignInclude("body", "template/_tp_mock.html");
$tpl->prepare();
...
<img src="' . $url_main . '/upload/slide/' . $line['BANNER_NAME'] . '" width="100%" height="100%" loading="lazy" alt="' . $line['TITLE'] . '" class="slide_visual slide' . $noSlide . '"></a>
